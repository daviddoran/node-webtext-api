...
function WebTextMessage(params) {
    ...
    if (params.hasOwnProperty('delivery_time') && params.delivery_time instanceof Date) {
        this.delivery_time = params.delivery_time;
    }
...
WebTextMessage.prototype.serialize = function () {
    ...
    if (this.unicode === null) {
        ...
        query.unicode = 1;
        query.hex = unicoder.encode(this.unicode);
    }
